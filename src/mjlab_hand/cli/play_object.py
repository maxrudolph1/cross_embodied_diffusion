#!/usr/bin/env python
"""Wrapper around mjlab's play script with --object and --scale CLI args."""
...
def main() -> None:
    # Pre-parse --object and --scale before passing everything else to mjlab play.
    ...
    # Reconstruct sys.argv so mjlab play sees only the args it understands.
    sys.argv = ["play"] + remaining
